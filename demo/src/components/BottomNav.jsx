...
const BottomNav = () => {
  ...
  return (
    <>
      <div className="fixed z-30 bottom-0 left-0 z-50 w-full h-20 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium px-7">
          <Link
            to="/"
            type="button"
            className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${
              isHomeActive ? "text-green-700" : "text-gray-500 dark:text-gray-400"
            }`}
          >
            <svg
              className={`w-5 h-5 mb-1 mt-2 ${
                isHomeActive ? "text-green-700" : "text-gray-500 dark:text-gray-400 group-hover:text-green-700 dark:group-hover:text-green-700"
              }`}
              aria-hidden="true"
          ...
          <Link
            ...
            type="button"
            className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${
              isTransaksiActive ? "text-green-700" : "text-gray-500 dark:text-gray-400"
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              fill="currentColor"
              className={`w-5 h-5 mb-1 mt-2 ${
                isTransaksiActive ? "text-green-700" : "text-gray-500 dark:text-gray-400 group-hover:text-green-700 dark:group-hover:text-green-700"
              }`}
            >
              <path
                fillRule="evenodd"
          ...
          >
            <div className="bg-white p-4 rounded-full mb-1 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 shadow-lg border -mt-16">
              <svg
                className={`w-12 h-12 ${
                  isPickupActive ? "text-green-700" : "text-gray-500 dark:text-gray-400 group-hover:text-green-700 dark:group-hover:text-green-700"
                }`}
                viewBox="0 0 46 46"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <span
              className={`text-sm text-gray-500 dark:text-gray-400 group-hover:text-green-700 dark:group-hover:text-green-700 absolute bottom-0 mb-3 ${
                isPickupActive ? "text-green-700" : ""
              }`}
            >
              Pickup
          ...
          <Link
            ...
            type="button"
            className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${
              isInboxActive ? "text-green-700" : "text-gray-500 dark:text-gray-400"
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              fill="currentColor"
              className={`w-5 h-5 mb-1 mt-2 ${
                isInboxActive ? "text-green-700" : "text-gray-500 dark:text-gray-400 group-hover:text-green-700 dark:group-hover:text-green-700"
              }`}
            >
          ...
          <Link
            ...
            type="button"
            className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${
              isProfileActive ? "text-green-700" : "text-gray-500 dark:text-gray-400"
            }`}
          >
            <svg
              className={`w-5 h-5 mb-1 mt-2 ${
                isProfileActive ? "text-green-700" : "text-gray-500 dark:text-gray-400 group-hover:text-green-700 dark:group-hover:text-green-700"
              }`}
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
